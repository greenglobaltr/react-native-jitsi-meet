            ...
            public void run() {
                if (mJitsiMeetViewReference.getJitsiMeetView() != null) {
                    ...
                    RNJitsiMeetConferenceOptions options = new RNJitsiMeetConferenceOptions.Builder()
                        ...
                        .setFeatureFlag("call-integration.enabled", meetFeatureFlags.hasKey("callIntegrationEnabled") ?meetFeatureFlags.getBoolean("callIntegrationEnabled") : false)
                        .setFeatureFlag("chat.enabled", meetFeatureFlags.hasKey("chatEnabled") ?meetFeatureFlags.getBoolean("chatEnabled") : true)
                        .setFeatureFlag("close-captions.enabled", meetFeatureFlags.hasKey("closeCaptionsEnabled") ?meetFeatureFlags.getBoolean("closeCaptionsEnabled") : false)
                        ...
                        .setFeatureFlag("live-streaming.enabled", meetFeatureFlags.hasKey("liveStreamingEnabled") ?meetFeatureFlags.getBoolean("liveStreamingEnabled") : false)
                        .setFeatureFlag("meeting-name.enabled", meetFeatureFlags.hasKey("meetingNameEnabled") ?meetFeatureFlags.getBoolean("meetingNameEnabled") : false)
                        .setFeatureFlag("meeting-password.enabled", meetFeatureFlags.hasKey("meetingPasswordEnabled") ?meetFeatureFlags.getBoolean("meetingPasswordEnabled") : false)
                        .setFeatureFlag("pip.enabled", meetFeatureFlags.hasKey("pipEnabled") ?meetFeatureFlags.getBoolean("pipEnabled") : true)
                        .setFeatureFlag("kick-out.enabled", meetFeatureFlags.hasKey("kickOutEnabled") ?meetFeatureFlags.getBoolean("kickOutEnabled") : false)
                        ...
                        .setFeatureFlag("security-options.enabled", meetFeatureFlags.hasKey("securityEnabled") ?meetFeatureFlags.getBoolean("securityEnabled") : false)
                        .setFeatureFlag("server-url-change.enabled", meetFeatureFlags.hasKey("serverUrlChangeEnabled") ?meetFeatureFlags.getBoolean("serverUrlChangeEnabled") : false)
                        .setFeatureFlag("replace.participant", meetFeatureFlags.hasKey("replaceParticipant") ?meetFeatureFlags.getBoolean("replaceParticipant") : false)
                        .setFeatureFlag("meeting-password.enabled", meetFeatureFlags.hasKey("meetingPasswordEnabled") ?meetFeatureFlags.getBoolean("meetingPasswordEnabled") : false)
                        .setFeatureFlag("help.enabled", meetFeatureFlags.hasKey("helpEnabled") ?meetFeatureFlags.getBoolean("helpEnabled") : false)
                        .setFeatureFlag("audio-only.enabled", meetFeatureFlags.hasKey("audioOnlyEnabled") ?meetFeatureFlags.getBoolean("audioOnlyEnabled") : false)
                        .build();
